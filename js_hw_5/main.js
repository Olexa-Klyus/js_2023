...
let areaCylinder = (h, r) => (2 * Math.PI * r * h) + (2 * Math.PI * r ** 2);
console.log(areaCylinder(10, 3))


// - створити функцію яка приймає масив та виводить кожен його елемент

let arrayToElements = (arr) => {
...
let textToParagraph = (text) => `<p>${text}</p>`;
console.log(textToParagraph("At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium"))
